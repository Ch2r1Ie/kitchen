      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <ComboboxTrigger
            ...
            className="group-has-data-[slot=combobox-clear]/input-group:hidden flex size-6 items-center justify-center rounded-sm text-muted-foreground hover:bg-accent hover:text-accent-foreground data-pressed:bg-transparent"
            disabled={disabled}
          />
        )}
